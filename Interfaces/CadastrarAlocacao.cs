...
{
    public partial class CadastrarAlocacao : Form
    {
        private static CadastrarAlocacao instance;

        private CadastrarAlocacao()
        {
            InitializeComponent();
        }
        public static CadastrarAlocacao GetInstance()
        {
            if (instance == null || instance.IsDisposed)
            {
                instance = new CadastrarAlocacao();
            }
